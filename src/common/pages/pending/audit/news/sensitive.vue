...
<script>
     ...
     * @modified 2018.12.27
     *
     * @description 敏感资讯列表 SensitiveNews
     * @augments
     * @example
     *
     */
    ...
    export default {
                                ...
                                (obj, i) => {
                                    ...
                                    switch (type) {
                                        case 1:
                                            ...
                                            routerPath = `/audit/news/sensitive/operate-handle`;
                                            break;
                                        case 2:
                                            operateUrl = `/tm/getNewsInfoById`;
                                            routerPath = `/audit/news/sensitive/operate-audit`;
                                            break;
                                        case 3:
                                            operateUrl = `/tm/getNewsInfoById`;
                                            routerPath = `/audit/news/sensitive/operate-verify`;
                                            break;
                                        case 5:
                                            operateUrl = `/tm/getNewsInfoById`;
                                            routerPath = `/audit/news/sensitive/operate-view`;
                                            break;
                                        default:
                                            operateUrl = `#type=删除`;
                                        ...
                                        on: {
                                            click: (e) => {
                                                ...
                                                if (type === 4) {
                                                    ...
                                                    window.sessionStorage.setItem(`sensitive_flipObj_${new_type}`, JSON.stringify(flipObj));
                                                    let router_query = {
                                                        type,
                                                        desc,
                                                        uid,
                                                    ...
                                                    window.sessionStorage.setItem(`sensitive_route_query_${new_type}`, JSON.stringify(router_query));
                                                    if (type === 5) {
        ...
        methods: {
            ...
            globalBindKeyboardShortcuts() {
                ...
                if (bindFlag === "true") {
                    console.log(`sensitive, body no need binding again!`);
                } else {
                    console.log(`sensitive, body only need binding once!`);
        ...
        mounted() {
            ...
            if (isGobalBindKS) {
                // only bind once
                console.warn(`sensitive, KeyboardShortcuts, only need bind once!`, isGobalBindKS);
            } else {
                // init bind
                console.info(`sensitive, KeyboardShortcuts, bind once!`, isGobalBindKS);
