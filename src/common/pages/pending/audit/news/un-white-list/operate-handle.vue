                    ...
                    <h-row class-name="common-handle-padding">
                        <h-col span="4">
                            <h-button
                                ...
                                ref="un-white-list_handle_save"
                                data-btn="un-white-list_handle_save"
                        ...
                        <h-col span="4" v-if="commonHandle.openFlag">
                            <h-button
                                :disabled="isEmptyNewsTitle"
                                ref="un-white-list_handle_open"
                                data-btn="un-white-list_handle_open"
                        ...
                        <h-col span="4" v-else>
                            <h-button
                                :disabled="isEmptyNewsTitle"
                                ref="un-white-list_handle_close"
                                data-btn="un-white-list_handle_close"
                        ...
                        <h-col span="6" v-if="commonHandle.openFlag">
                            <h-button
                                :disabled="isEmptyNewsTitle"
                                ref="un-white-list_handle_forever_shield"
                                data-btn="un-white-list_handle_forever_shield"
                        ...
                        <h-col span="6" v-else>
                            <h-button
                                :disabled="isEmptyNewsTitle"
                                ref="un-white-list_handle_passed"
                                data-btn="un-white-list_handle_passed"
                        ...
                        <h-col span="4">
                            <h-button
                                ...
                                ref="un-white-list_handle_prev"
                                data-btn="un-white-list_handle_prev"
                        ...
                        <h-col span="4">
                            <h-button
                                ref="un-white-list_handle_next"
                                data-btn="un-white-list_handle_next"
                                :disabled="isLastNews"
    ...
    export default {
        ...
        methods: {
            ...
            sessionRouterQuery(id = ``) {
                let router_query = JSON.parse(window.sessionStorage.getItem(`un-white-list_route_query_handle`));
                let {
                    type,
                    desc,
                    // uid,
                ...
                window.sessionStorage.setItem(`un-white-list_route_query_handle`, JSON.stringify(new_router_query));
            },
            sessionFilterObj(id = ``) {
                let pageFlipObj = JSON.parse(window.sessionStorage.getItem("un-white-list_flipObj_handle"));
                // this.pageFlipObj = pageFlipObj || {};
                this.pageFlipObj.newsId = id;
                // pageFlipObj
                let new_pageFlipObj = Object.assign({}, this.pageFlipObj);
                window.sessionStorage.setItem(`un-white-list_flipObj_handle`, JSON.stringify(new_pageFlipObj));
            },
            reSureCancel() {
            ...
            returnParentPage () {
                // re-direct
                let path = `/audit/news/un-white-list/operate-handle`;
                this.$store.commit("DEL_TAB", path);
                this.$router.push(`/audit/news/un-white-list`);
            },
            ...
            onClickButton (type = ``) {
                ...
                switch (type) {
                    ...
                    case "passed":
                        ...
                        path = `/audit/news/tag/operate-handle`;
                        break;
                    case "forever_shield":
                ...
                if (!xwbt) {
                    ...
                    this.$hMessage.info(`资讯标题不可以为空!`);
                } else if (tags.length === 0 && type === "open") {
