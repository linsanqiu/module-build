    ...
    export default {
        ...
        methods: {
            ...
            sessionRouterQuery(id = ``) {
                let router_query = JSON.parse(window.sessionStorage.getItem(`bid-tag_route_query_audit`));
                let {
                    type,
                    desc,
                    // uid,
                ...
                window.sessionStorage.setItem(`bid-tag_route_query_audit`, JSON.stringify(new_router_query));
            },
            sessionFilterObj(id = ``) {
                let pageFlipObj = JSON.parse(window.sessionStorage.getItem("bid-tag_flipObj_audit"));
                // this.pageFlipObj = pageFlipObj || {};
                this.pageFlipObj.newsId = id;
                // pageFlipObj
                let new_pageFlipObj = Object.assign({}, this.pageFlipObj);
                window.sessionStorage.setItem(`bid-tag_flipObj_audit`, JSON.stringify(new_pageFlipObj));
            },
            // shortcut keys
            ...
            returnParentPage () {
                // re-direct
                let path = `/audit/news/bid-tag/operate-audit`;
