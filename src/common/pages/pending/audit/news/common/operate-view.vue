                    ...
                    <h-row class-name="common-handle-padding">
                        ...
                        <h-col span="4">
                            <h-button
                                ...
                                ref="common_view_prev"
                                data-btn="common_view_prev"
                        ...
                        <h-col span="4">
                            <h-button
                                :disabled="isLastNews"
                                ref="common_view_next"
                                data-btn="common_view_next"
    ...
    export default {
        ...
        methods: {
            ...
            sessionRouterQuery(id = ``) {
                let router_query = JSON.parse(window.sessionStorage.getItem(`common_route_query_view`));
                let {
                    type,
                    desc,
                    // uid,
                ...
                window.sessionStorage.setItem(`common_route_query_view`, JSON.stringify(new_router_query));
            },
            sessionFilterObj(id = ``) {
                let pageFlipObj = JSON.parse(window.sessionStorage.getItem("common_flipObj_view"));
                // this.pageFlipObj = pageFlipObj || {};
                this.pageFlipObj.newsId = id;
                // pageFlipObj
                let new_pageFlipObj = Object.assign({}, this.pageFlipObj);
                window.sessionStorage.setItem(`common_flipObj_view`, JSON.stringify(new_pageFlipObj));
            },
            // shortcut keys
            keyboardShortcutKeys() {
                ...
                // let body = document.querySelector(`[data-body="common-view"]`);
                        ...
                        if(e.which === 68 && isCtrl) {
                            if (that.clickGetNewsInfos) {
                                if (!that.isFirstNews) {
                                    ...
                                    that.$refs.common_view_prev.$emit("click");
                                    console.log(`common view & prev btn click ok!`);
                                } else {
                                    // btn bug
                        ...
                        if(e.which === 70 && isCtrl) {
                            if (that.clickGetNewsInfos) {
                                if (!that.isLastNews) {
                                    ...
                                    that.$refs.common_view_next.$emit("click");
                                    console.log(`common view & next btn click ok!`);
                                } else {
                                    // btn bug
            ...
            returnParentPage () {
                let path = `/audit/news/common/operate-view`;
        ...
        activated() {
            ...
            console.log(`common_view tab 激活!`);
        },
    }
</script>
