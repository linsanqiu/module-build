<template>
    <section>
        ...
        <div class="audit-common-content">
            ...
            <!-- <h-row class-name="audit-common-row-padding" v-else>
                <h-col span="4">
                    <h-button
                        type="primary"
                        icon="search"
    ...
    export default {
                                ...
                                (obj, i) => {
                                    ...
                                    switch (type) {
                                        case 1:
                                            ...
                                            routerPath = `/audit/news/common/operate-handle`;
                                            break;
                                        case 2:
                                            operateUrl = `/tm/getNewsInfoById`;
                                            routerPath = `/audit/news/common/operate-audit`;
                                            break;
                                        case 3:
                                            operateUrl = `/tm/getNewsInfoById`;
                                            routerPath = `/audit/news/common/operate-verify`;
                                            break;
                                        case 5:
                                            operateUrl = `/tm/getNewsInfoById`;
                                            routerPath = `/audit/news/common/operate-view`;
                                            break;
                                        default:
                                            operateUrl = `#type=删除`;
                                            // case: 4
                                    ...
                                    return h("a", {
                                        attrs: {
                                            "data-url": operateUrl,
                                            "data-type": type,
                                            "data-type-link": `audit-common-${type}`,
                                        },
                                        class: [
                                            "audit-common-link",
                                        ],
                                        ...
                                        on: {
                                            click: (e) => {
                                                ...
                                                // let alink = document.querySelector(`a[data-type-link="audit-common-${type}"]`);
                                                // console.log(`e =`, e);
                                                ...
                                                if (type === 4) {
                                                    ...
                                                    window.sessionStorage.setItem(`common_flipObj_${new_type}`, JSON.stringify(flipObj));
                                                    let router_query = {
                                                        type,
                                                        desc,
                                                        uid,
                                                    ...
                                                    window.sessionStorage.setItem(`common_route_query_${new_type}`, JSON.stringify(router_query));
                                                    if (type === 5) {
                                                        // 查看
        ...
        methods: {
            ...
            checkLockState (uid = ``, options = {}) {
                ...
                .then((json)=>{
                    ...
                    if(status != this.$api.SUCCESS){
                        ...
                        if (status === 1) {
                            // re-direct
                            console.log(`router options =`, JSON.stringify(options, null, 4));
                            this.$router.push(options);
                        }
                    }
            ...
            getCommonTableDatas (options = {}, debug = false) {
                ...
                // } = options;
                // 一般资讯列表
                options.newsListType = "0";
                this.tableLoading = true;
                let url = `/tm/getCommonNewsLogVoList`;
                this.$http
                .post(url, options)
                .then(res => res.data)
                .then((json)=>{
            ...
            globalBindKeyboardShortcuts() {
                ...
                if (bindFlag === "true") {
                    console.log(`common, body no need binding again!`);
                } else {
                    console.log(`common, body only need binding once!`);
        ...
        mounted() {
            ...
            if (isGobalBindKS) {
                // only bind once
                console.warn(`common, KeyboardShortcuts, only need bind once!`, isGobalBindKS);
            } else {
                // init bind
                console.info(`common, KeyboardShortcuts, bind once!`, isGobalBindKS);
