                ...
                <h-col span="10" push="1">
                    <h-row class-name="common-handle-padding">
                        ...
                        <h-col span="4" v-else>
                            <h-button
                                :disabled="isEmptyNewsTitle"
                                ref="tag_handle_close"
                                data-btn="tag_handle_close"
                        ...
                        <h-col span="6" v-if="commonHandle.openFlag">
                            <h-button
                                :disabled="isEmptyNewsTitle"
                                ref="tag_handle_forever_shield"
                                data-btn="tag_handle_forever_shield"
                        ...
                        <h-col span="6" v-else>
                            <h-button
                                :disabled="isEmptyNewsTitle"
                                ref="tag_handle_passed"
                                data-btn="tag_handle_passed"
                ...
                <h-col span="12">
                    <h-row class-name="common-handle-padding">
                        <h-col span="24">
                            ...
                            <h-row class-name="common-handle-padding">
                                <h-col span="12">
                                    <!-- <span class="audit-common-lable">稽核意见</span>
                                    <h-input
                                        aria-placeholder="稽核意见"
                                        placeholder="请输入稽核意见"
                                        style="width: 60%"
    ...
    export default {
        ...
        methods: {
            ...
            sessionRouterQuery(id = ``) {
                let router_query = JSON.parse(window.sessionStorage.getItem(`tag_route_query_handle`));
                let {
                    type,
                    desc,
                    // uid,
                ...
                window.sessionStorage.setItem(`tag_route_query_handle`, JSON.stringify(new_router_query));
            },
            sessionFilterObj(id = ``) {
                let pageFlipObj = JSON.parse(window.sessionStorage.getItem("tag_flipObj_handle"));
                // this.pageFlipObj = pageFlipObj || {};
                this.pageFlipObj.newsId = id;
                // pageFlipObj
                let new_pageFlipObj = Object.assign({}, this.pageFlipObj);
                window.sessionStorage.setItem(`tag_flipObj_handle`, JSON.stringify(new_pageFlipObj));
            },
            reSureCancel() {
            ...
            clickGetNewsId() {
                ...
                if (newsID) {
                    ...
                    // input.style = `width: 100%; min-width: 215px; color: #000; cursor: pointer !important;`;
                    input.addEventListener(`click`, (e) => {
                        try {
                            if (result) {
                                input.select();
            ...
            returnParentPage () {
                // re-direct
                let path = `/audit/news/tag/operate-handle`;
                this.$store.commit("DEL_TAB", path);
                this.$router.push(`/audit/news/tag`);
            },
            ...
            asyncNewAdd () {
                ...
                // console.log(`labelCategoryId =`, labelCategoryId, typeof(labelCategoryId));
