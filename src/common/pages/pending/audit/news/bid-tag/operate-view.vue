<template>
    <section data-body="bid-tag-view">
                    ...
                    <h-row class-name="common-handle-padding">
                        ...
                        <h-col span="4">
                            <h-button
                                ...
                                ref="bid-tag_view_prev"
                                data-btn="bid-tag_view_prev"
                        ...
                        <h-col span="4">
                            <h-button
                                :disabled="isLastNews"
                                ref="bid-tag_view_next"
                                data-btn="bid-tag_view_next"
    ...
    export default {
        ...
        methods: {
            ...
            sessionRouterQuery(id = ``) {
                let router_query = JSON.parse(window.sessionStorage.getItem(`bid-tag_route_query_view`));
                let {
                    type,
                    desc,
                    // uid,
                ...
                window.sessionStorage.setItem(`bid-tag_route_query_view`, JSON.stringify(new_router_query));
            },
            sessionFilterObj(id = ``) {
                let pageFlipObj = JSON.parse(window.sessionStorage.getItem("bid-tag_flipObj_view"));
                // this.pageFlipObj = pageFlipObj || {};
                this.pageFlipObj.newsId = id;
                // pageFlipObj
                let new_pageFlipObj = Object.assign({}, this.pageFlipObj);
                window.sessionStorage.setItem(`bid-tag_flipObj_view`, JSON.stringify(new_pageFlipObj));
            },
            ...
            keyboardShortcutKeys() {
                ...
                // let body = document.querySelector(`[data-body="bid-tag-view"]`);
            ...
            returnParentPage () {
                let path = `/audit/news/bid-tag/operate-view`;
