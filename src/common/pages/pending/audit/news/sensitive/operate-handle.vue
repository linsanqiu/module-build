                    ...
                    <h-row class-name="common-handle-padding">
                        <h-col span="4">
                            <h-button
                                ...
                                ref="sensitive_handle_save"
                                data-btn="sensitive_handle_save"
                        ...
                        <h-col span="6">
                            <h-button
                                ref="sensitive_handle_forever_shield"
                                data-btn="sensitive_handle_forever_shield"
                        ...
                        <!-- <h-col span="6">
                            <h-button
                                ref="sensitive_handle_passed"
                                data-btn="sensitive_handle_passed"
                        ...
                        <h-col span="4" v-if="commonHandle.openFlag">
                            <h-button
                                :disabled="isEmptyNewsTitle"
                                ref="sensitive_handle_open"
                                data-btn="sensitive_handle_open"
                        ...
                        <h-col span="4" v-else>
                            <h-button
                                :disabled="isEmptyNewsTitle"
                                ref="sensitive_handle_close"
                                data-btn="sensitive_handle_close"
                        ...
                        <h-col span="4">
                            <h-button
                                ...
                                ref="sensitive_handle_prev"
                                data-btn="sensitive_handle_prev"
                        ...
                        <h-col span="4">
                            <h-button
                                :disabled="isLastNews"
                                ref="sensitive_handle_next"
                                data-btn="sensitive_handle_next"
    ...
    export default {
        ...
        methods: {
            ...
            sessionRouterQuery(id = ``) {
                let router_query = JSON.parse(window.sessionStorage.getItem(`sensitive_route_query_handle`));
                let {
                    type,
                    desc,
                    // uid,
                ...
                window.sessionStorage.setItem(`sensitive_route_query_handle`, JSON.stringify(new_router_query));
            },
            sessionFilterObj(id = ``) {
                let pageFlipObj = JSON.parse(window.sessionStorage.getItem("sensitive_flipObj_handle"));
                // this.pageFlipObj = pageFlipObj || {};
                this.pageFlipObj.newsId = id;
                // pageFlipObj
                let new_pageFlipObj = Object.assign({}, this.pageFlipObj);
                window.sessionStorage.setItem(`sensitive_flipObj_handle`, JSON.stringify(new_pageFlipObj));
            },
            reSureCancel() {
            ...
            onClickButton (type = ``) {
                ...
                switch (type) {
                    ...
                    case "close":
                        ...
                        break;
                    case "forever_shield":
                        url = `/tm/specialProcessedByNewsId`;// 处理通过
                        path = `/audit/news/sensitive/operate-handle`;
                        break;
                    // case "passed":
                    //     url = `/tm/specialProcessedByNewsId`;// 处理通过
