<template>
    <section data-body="bid-tag-handle">
                    ...
                    <h-row class-name="common-handle-padding">
                        <h-col span="4">
                            <h-button
                                ...
                                ref="bid-tag_handle_save"
                                data-btn="bid-tag_handle_save"
                        ...
                        <h-col span="4" v-if="commonHandle.openFlag">
                            <h-button
                                :disabled="isEmptyNewsTitle"
                                ref="bid-tag_handle_open"
                                data-btn="bid-tag_handle_open"
                        ...
                        <h-col span="4" v-else>
                            <h-button
                                :disabled="isEmptyNewsTitle"
                                ref="bid-tag_handle_close"
                                data-btn="bid-tag_handle_close"
                        ...
                        <h-col span="6" v-if="commonHandle.openFlag">
                            <h-button
                                :disabled="isEmptyNewsTitle"
                                ref="bid-tag_handle_forever_shield"
                                data-btn="bid-tag_handle_forever_shield"
                        ...
                        <h-col span="6" v-else>
                            <h-button
                                :disabled="isEmptyNewsTitle"
                                ref="bid-tag_handle_passed"
                                data-btn="bid-tag_handle_passed"
                        ...
                        <h-col span="4">
                            <h-button
                                ...
                                ref="bid-tag_handle_prev"
                                data-btn="bid-tag_handle_prev"
                        ...
                        <h-col span="4">
                            <h-button
                                :disabled="isLastNews"
                                ref="bid-tag_handle_next"
                                data-btn="bid-tag_handle_next"
                                                    ...
                                                    <h-col span="6" class-name="bid-table-row">
                                                        <span class="audit-common-bid-lable">
                                                            <a
                                                                ...
                                                                <!-- @click="showDeleteBidModal(index)">删除</a> -->
                                                                <!-- @click="this.showDeleteBidModal(index)">删除</a> -->
                                                                <!-- @click="() => this.showDeleteModal({0, 0})">删除</a> -->
    ...
    export default {
                                ...
                                h("a", {
                                    ...
                                    on: {
                                        click: () => {
                                            ...
                                            // console.log(`deleteLabelName =`, labelName);
                                            this.showDeleteModal({
                                                uid,
                                                index,
                                            });
        ...
        methods: {
            ...
            sessionRouterQuery(id = ``) {
                let router_query = JSON.parse(window.sessionStorage.getItem(`bid-tag_route_query_handle`));
                let {
                    type,
                    desc,
                    // uid,
                ...
                window.sessionStorage.setItem(`bid-tag_route_query_handle`, JSON.stringify(new_router_query));
            },
            sessionFilterObj(id = ``) {
                let pageFlipObj = JSON.parse(window.sessionStorage.getItem("bid-tag_flipObj_handle"));
                // this.pageFlipObj = pageFlipObj || {};
                this.pageFlipObj.newsId = id;
                // pageFlipObj
                let new_pageFlipObj = Object.assign({}, this.pageFlipObj);
                window.sessionStorage.setItem(`bid-tag_flipObj_handle`, JSON.stringify(new_pageFlipObj));
            },
            reSureCancel() {
            ...
            getBidsByClickSelect (bid_name = {}, index = 0) {
                ...
                // console.log(`bid_name =`, JSON.stringify(bid_name, null, 4));
                let {
                    tagName,
                    filterType,
                } = bid_name;
            ...
            // onBidSelectChangeJSX(index = 0, obj = {}) {
            //     console.log(`index =`, index);
            //     console.log(`jsx obj =`, JSON.stringify(obj, null, 4));
            // },
            // onBidSelectChange(index = 0, obj = {}) {
            //     console.log(`index =`, index);
            ...
            keyboardShortcutKeys() {
                ...
                // let body = document.querySelector(`[data-body="bid-tag-handle"]`);
            ...
            returnParentPage () {
                // re-direct
                let path = `/audit/news/bid-tag/operate-handle`;
                this.$store.commit("DEL_TAB", path);
                this.$router.push(`/audit/news/bid-tag`);
            },
            ...
            onClickButton (type = ``) {
                ...
                // console.log(`personTag =`, JSON.stringify(personTag, null, 4));
                let url = ``;
                let path = ``;
                switch (type) {
                    case "save":
                    ...
                    case "open":
                        ...
                        path = `/audit/news/big-tag/operate-handle`;
                        break;
                    case "close":
            ...
            getHandleInfos(uniqueNewsId = ``) {
                ...
                .then((json)=>{
                    ...
                    if(status != this.$api.SUCCESS){
                        ...
                        // console.log(`this.isBidTagsEmpty =`, this.isBidTagsEmpty);
                        // console.log(`!this.isBidTagsEmpty =`, !this.isBidTagsEmpty);
                        if(dataStatus === 0) {
        ...
        mounted() {
            ...
            // setTimeout(() => {
            //     let selects = [...document.querySelectorAll(`.shit-h_ui-table-cell`)];
            //     selects.forEach(
            //         (select, i) => {
            //             // console.log(`select =`, select);
            //             if (i > 0) {
            //                 // select.firstElementChild.style = "overflow-y: auto !important";
            //             }
            //         }
            //     );
            // }, 3000);
