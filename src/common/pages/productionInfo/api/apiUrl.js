...
// const GET_TEMP_GROUPS = `${base}sys/getDict?dictCode=BIZ_GROUP`
...
const GET_TABLE_HEADER = `${base}prodData/getProdFieldList`


const GET_DICT_LIST = `${dictBase}getDict`

const CHECK_VERIFY_DATA = `${base}anncData/checkAnncData`
const CHECK_VERIFY_DATA_FROM_LIST = `${base}prodData/checkProdData`
