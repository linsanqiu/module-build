                    ...
                    <div v-if="!isNeedReturnOrigin">
                        <h-col span="4">
                            <h-button
                                ...
                                ref="emergency-off-shelves_view-bid_prev"
                                data-btn="emergency-off-shelves_view-bid_prev"
                        ...
                        <h-col span="4">
                            <h-button
                                :disabled="isLastNews"
                                ref="emergency-off-shelves_view-bid_next"
                                data-btn="emergency-off-shelves_view-bid_next"
                                            ...
                                            <h-col span="24">
                                                <div v-for="(obj, index) in bidHandleTableDatas" :key="index">
                                                    ...
                                                    <h-col span="6" class-name="bid-table-row">
                                                        ...
                                                        <!-- <span class="audit-common-bid-lable">
                                                            {{obj.tagOptions[0].name}}
                                                        </span> -->
                                                        <!-- <span class="audit-common-bid-lable">
                                                            {{obj.tagOptions[0].bid}}
                                                        </span> -->
                                                        <!-- <div
                                                            ...
                                                            <select
                                                                ...
                                                                @change="onBidSelectChange(obj.tagIndex, obj)"
                                                                :key="index">
                                                                <option
    ...
    export default {
        ...
        methods: {
            ...
            sessionRouterQuery(id = ``) {
                let router_query = JSON.parse(window.sessionStorage.getItem(`emergency-off-shelves_route_query_view_bid`));
                let {
                    type,
                    desc,
                    // uid,
                ...
                window.sessionStorage.setItem(`emergency-off-shelves_route_query_view_bid`, JSON.stringify(new_router_query));
            },
            sessionFilterObj(id = ``) {
                let pageFlipObj = JSON.parse(window.sessionStorage.getItem("emergency-off-shelves_flipObj_view_bid"));
                // this.pageFlipObj = pageFlipObj || {};
                this.pageFlipObj.newsId = id;
                // pageFlipObj
                let new_pageFlipObj = Object.assign({}, this.pageFlipObj);
                window.sessionStorage.setItem(`emergency-off-shelves_flipObj_view_bid`, JSON.stringify(new_pageFlipObj));
            },
