                    ...
                    <h-row class-name="common-handle-padding">
                        ...
                        <h-col span="4">
                            <h-button
                                ...
                                ref="recheck_view_prev"
                                data-btn="recheck_view_prev"
                        ...
                        <h-col span="4">
                            <h-button
                                :disabled="isLastNews"
                                ref="recheck_view_next"
                                data-btn="recheck_view_next"
    ...
    export default {
        ...
        methods: {
            ...
            sessionRouterQuery(id = ``) {
                let router_query = JSON.parse(window.sessionStorage.getItem(`recheck_route_query_view`));
                let {
                    type,
                    desc,
                    // uid,
                ...
                window.sessionStorage.setItem(`recheck_route_query_view`, JSON.stringify(new_router_query));
            },
            sessionFilterObj(id = ``) {
                let pageFlipObj = JSON.parse(window.sessionStorage.getItem("recheck_flipObj_view"));
                // this.pageFlipObj = pageFlipObj || {};
                this.pageFlipObj.newsId = id;
                // pageFlipObj
                let new_pageFlipObj = Object.assign({}, this.pageFlipObj);
                window.sessionStorage.setItem(`recheck_flipObj_view`, JSON.stringify(new_pageFlipObj));
            },
            // shortcut keys
            ...
            returnParentPage () {
                let path = `/audit/news/recheck/operate-view`;
