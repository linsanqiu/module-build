    ...
    export default {
        ...
        methods: {
            ...
            sessionRouterQuery(id = ``) {
                let router_query = JSON.parse(window.sessionStorage.getItem(`sensitive_route_query_audit`));
                let {
                    type,
                    desc,
                    // uid,
                ...
                window.sessionStorage.setItem(`sensitive_route_query_audit`, JSON.stringify(new_router_query));
            },
            sessionFilterObj(id = ``) {
                let pageFlipObj = JSON.parse(window.sessionStorage.getItem("sensitive_flipObj_audit"));
                // this.pageFlipObj = pageFlipObj || {};
                this.pageFlipObj.newsId = id;
                // pageFlipObj
                let new_pageFlipObj = Object.assign({}, this.pageFlipObj);
                window.sessionStorage.setItem(`sensitive_flipObj_audit`, JSON.stringify(new_pageFlipObj));
            },
            // shortcut keys
            keyboardShortcutKeys() {
                // // get flip page object
                // let pageFlipObj = JSON.parse(window.sessionStorage.getItem("flipObj"));
                // console.log(`common audit pageFlipObj init =`, JSON.stringify(pageFlipObj, null, 4));
                // this.pageFlipObj = pageFlipObj || {};
                let that = this;
