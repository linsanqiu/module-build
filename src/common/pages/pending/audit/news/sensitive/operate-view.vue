                    ...
                    <h-row class-name="common-handle-padding">
                        ...
                        <h-col span="4">
                            <h-button
                                ...
                                ref="sensitive_view_prev"
                                data-btn="sensitive_view_prev"
                        ...
                        <h-col span="4">
                            <h-button
                                :disabled="isLastNews"
                                ref="sensitive_view_next"
                                data-btn="sensitive_view_next"
    ...
    export default {
        ...
        methods: {
            ...
            sessionRouterQuery(id = ``) {
                let router_query = JSON.parse(window.sessionStorage.getItem(`sensitive_route_query_view`));
                let {
                    type,
                    desc,
                    // uid,
                ...
                window.sessionStorage.setItem(`sensitive_route_query_view`, JSON.stringify(new_router_query));
            },
            sessionFilterObj(id = ``) {
                let pageFlipObj = JSON.parse(window.sessionStorage.getItem("sensitive_flipObj_view"));
                // this.pageFlipObj = pageFlipObj || {};
                this.pageFlipObj.newsId = id;
                // pageFlipObj
                let new_pageFlipObj = Object.assign({}, this.pageFlipObj);
                window.sessionStorage.setItem(`sensitive_flipObj_view`, JSON.stringify(new_pageFlipObj));
            },
            // shortcut keys
            ...
            clickGetNewsInfos (type = ``) {
                ...
                // let pageFlipObj = JSON.parse(window.sessionStorage.getItem("flipObj"));
                let {
                    dataStatus,
                    // dataType,
                    newsListType,
            ...
            returnParentPage () {
                let path = `/audit/news/sensitive/operate-view`;
