    ...
    export default {
        ...
        methods: {
            ...
            sessionRouterQuery(id = ``) {
                let router_query = JSON.parse(window.sessionStorage.getItem(`un-white-list_route_query_audit`));
                let {
                    type,
                    desc,
                    // uid,
                ...
                window.sessionStorage.setItem(`un-white-list_route_query_audit`, JSON.stringify(new_router_query));
            },
            sessionFilterObj(id = ``) {
                let pageFlipObj = JSON.parse(window.sessionStorage.getItem("un-white-list_flipObj_audit"));
                // this.pageFlipObj = pageFlipObj || {};
                this.pageFlipObj.newsId = id;
                // pageFlipObj
                let new_pageFlipObj = Object.assign({}, this.pageFlipObj);
                window.sessionStorage.setItem(`un-white-list_flipObj_audit`, JSON.stringify(new_pageFlipObj));
            },
            // shortcut keys
            ...
            returnParentPage () {
                let path = `/audit/news/un-white-list/operate-audit`;
