...
(function() {
		...
		return {
			...
			on: function(b, d, g, h, k) {
				...
				if (0 > f.getListenerIndex(d)) {
					...
					n.fn = d;
					n.priority = k;
					for (var w = f.length - 1; 0 <= w; w--) if (f[w].priority <= k) return f.splice(w + 1, 0, n),
					{
						removeListener: q
					};
					f.unshift(n)
				...
				return function(k, n, q) {
					...
					if (f) {
						...
						if (w.length) for (var w = w.slice(0), A, G = 0; G < w.length; G++) {
							...
							} catch(x) {} else A = w[G].call(this, q, n, b, h); ! 1 === A ? g = 1 : "undefined" != typeof A && (n = A);
							if (a || g) break
						}
					}
	...
	CKEDITOR.dom = {}; (function() {
		...
		CKEDITOR.tools = {
			...
			enableHtml5Elements: function(a, f) {
				for (var b = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), c = b.length, k; c--;) k = a.createElement(b[c]),
				f && a.appendChild(k)
			},
			checkIfAnyArrayItemMatches: function(a, f) {
				for (var b = 0,
				c = a.length; b < c; ++b) if (a[b].match(f)) return ! 0;
				return ! 1
			},
	...
	CKEDITOR.dom.element.clearMarkers = function(a, d, b) {
		...
		function c(a) {
			for (var b = 0,
			c = 0,
			f = h[a].length; c < f; c++) b += parseFloat(this.getComputedStyle(h[a][c]) || 0, 10) || 0;
			return b
		}
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
			...
			removeStyle: function(a) {
				...
				this.$.style.cssText || this.removeAttribute("style");
					...
					for (var b = [], d = 0; d < c.length; d++) if (f) for (var w = 0; w < f.length; w++) b.push([a, c[d], f[w]].join("-"));
			...
			getDocumentPosition: function(a) {
				...
				if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ? 8 !== CKEDITOR.env.version: 1)) {
					...
					for (; m && !m.equals(x);) b -= m.$.scrollLeft,
					c -= m.$.scrollTop,
					m = m.getParent();
					m = x;
			...
			scrollIntoParent: function(a, b, c) {
				...
				d = d.y + I + m(this, "bottom") - (z.y + l) || 0; (0 > e || 0 < d) && g(0, !0 === b ? e: !1 === b ? d: 0 > e ? e: d);
			...
			copyAttributes: function(a, b) {
				...
				for (var f = 0; f < c.length; f++) {
					...
					e;
					if (! (w in b)) if ("checked" == w && (e = this.getAttribute(w))) a.setAttribute(w, e);
					else if (!CKEDITOR.env.ie || this.hasAttribute(w)) e = this.getAttribute(w),
	...
	!0, {
		...
		function a(a, b) {
			...
			if (!a && !this._.guardLTR) {
				...
				this._.guardLTR = function(a, b) {
					return (!b || !H.equals(a)) && (!k || !a.equals(k)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
				}
			}
			...
			this.current ? f = this.current[J](!1, r, g) : (a ? f.type == CKEDITOR.NODE_ELEMENT && (f = 0 < D ? f.getChild(D - 1) : !1 === g(f, !0) ? null: f.getPreviousSourceNode(!0, r, g)) : (f = d, f.type == CKEDITOR.NODE_ELEMENT && ((f = f.getChild(e)) || (f = !1 === g(d, !0) ? null: d.getNextSourceNode(!0, r, g)))), f && !1 === g(f) && (f = null));
			for (; f && !this._.end;) {
				this.current = f;
		...
		CKEDITOR.dom.walker.empty = function(a) {
			return function(b) {
				for (var c = 0,
				f = b.getChildCount(); c < f; ++c) if (!q(b.getChild(c))) return !! a;
				return ! a
			}
		};
		...
		CKEDITOR.dom.walker.editable = function(a) {
			return function(b) {
				b = q(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(D) && f(b)) ? !0 : !1;
				return !! (a ^ b)
			}
		};
	...
	CKEDITOR.dom.range = function(a) {
		...
		function d(a, b, c, d, e) {
			...
			function k() {
				var b = C - 1,
				c = v && B && !r.equals(J);
				b < t - 1 || b < F - 1 || c ? (c ? a.moveToPosition(J, CKEDITOR.POSITION_BEFORE_START) : F == b + 1 && y ? a.moveToPosition(p[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(p[b + 1], CKEDITOR.POSITION_BEFORE_START), d && (b = O[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT && (c = CKEDITOR.dom.element.createFromHtml('\x3cspan data-cke-bookmark\x3d"1" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e', a.document), c.insertAfter(b), b.mergeSiblings(!1), a.moveToBookmark({
					startNode: c
				}))) : a.collapse(!0)
			}
			a.optimizeBookmark();
			...
			if (l && J.type == CKEDITOR.NODE_TEXT && (r.equals(J) || r.type === CKEDITOR.NODE_ELEMENT && r.getFirst().equals(J))) c.append(a.document.createText(J.substring(H, E)));
				...
				for (var O = r.getParents(), p = J.getParents(), C = m(), t = O.length - 1, F = p.length - 1, N = c, X, Y, U, ea = -1, P = C; P <= t; P++) {
					Y = O[P];
					U = Y.getNext();
				...
				N = c;
				for (P = C; P <= F; P++) if (c = p[P], U = c.getPrevious(), c.equals(O[P])) b && (N = N.getChild(0));
				else {
		...
		function e(a) {
			return function() {
				var b;
				return this[a ? "getPreviousNode": "getNextNode"](function(a) { ! b && q(a) && (b = a);
		...
		CKEDITOR.dom.range.prototype = {
			...
			enlarge: function(a, b) {
				...
				case CKEDITOR.ENLARGE_ELEMENT:
					...
					E.type == CKEDITOR.NODE_TEXT ? (y && (E = !CKEDITOR.tools.trim(E.substring(0, y)).length && E, H = !!E), E && ((r = E.getPrevious()) || (l = E.getParent()))) : (y && (r = E.getChild(y - 1) || E.getLast()), r || (l = E));
					for (l = c(l); l || r;) {
						if (l && !r) { ! J && l.equals(m) && (J = !0);
							if (e ? l.isBlockBoundary() : !k.contains(l)) break;
							H && "inline" == l.getComputedStyle("display") || (H = !1, J ? h = l: this.setStartBefore(l));
							r = l.getPrevious()
						}
						for (; r;) if (E = !1, r.type == CKEDITOR.NODE_COMMENT) r = r.getPrevious();
						else {
							if (r.type == CKEDITOR.NODE_TEXT) u = r.getText(),
							d.test(u) && (r = null),
							E = /[\s\ufeff]$/.test(u);
							else if ((r.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && r.is("br")) && !r.data("cke-bookmark")) if (H && CKEDITOR.dtd.$removeEmpty[r.getName()]) {
								u = r.getText();
								if (d.test(u)) r = null;
								else for (var y = r.$.getElementsByTagName("*"), v = 0, B; B = y[v++];) if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) {
									r = null;
									break
								}
								r && (E = !!u.length)
					...
					l = r = null;
					J = H = !1;
					E.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(E.substring(y)).length ? H = !0 : (H = !E.getLength(), y == E.getLength() ? (r = E.getNext()) || (l = E.getParent()) : g(E, y) && (l = E.getParent())) : (r = E.getChild(y)) || (l = E);
					for (; l || r;) {
						if (l && !r) { ! J && l.equals(m) && (J = !0);
							if (e ? l.isBlockBoundary() : !k.contains(l)) break;
						...
						for (; r;) {
							...
							E = /^[\s\ufeff]/.test(u);
								...
								if ((0 < r.$.offsetWidth || b && r.is("br")) && !r.data("cke-bookmark")) if (H && CKEDITOR.dtd.$removeEmpty[r.getName()]) {
									u = r.getText();
									if (d.test(u)) r = null;
									else for (y = r.$.getElementsByTagName("*"), v = 0; B = y[v++];) if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) {
										r = null;
										break
									}
									r && (E = !!u.length)
			...
			_find: function(a, b) {
				...
				k,
				h;
				if (c && c.find) for (m = c.find(a), g = 0; g < m.count(); g++) if (c = m.getItem(g), b || !c.isReadOnly()) k = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c),
				h = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED || d.endNode.equals(c),
				k && h && e.push(c);
				return e
			}
		};
	...
	CKEDITOR.config = {
		...
		function a(a, b, c, d, e) {
			...
			for (d = a.length; c < d; ++c) {
				...
				if (!0 === f.elements || null === f.elements) e[l ? "unshift": "push"](f);
				else for (k in t = f.elements, delete f.elements, t) if (b[k]) b[k][l ? "unshift": "push"](f);
				else b[k] = [f]
			}
		}
		function d(a, c, d, e) {
		...
		function c(a, b, c) {
			if (!a.match || a.match(b)) {
				...
				if (a) {
					for (var d = !1,
					f = !0 === a,
					t = b.length; t--;) if (f || a(b[t])) b.splice(t, 1),
					d = !0;
					a = d
				} else a = !1;
		...
		function f(a) {
			var b, c, d, e, f = {},
			t = 1;
			for (a = B(a); b = a.match(p);)(c = b[2]) ? (d = D(c, "styles"), e = D(c, "attrs"), c = D(c, "classes")) : d = e = c = null,
			f["$" + t++] = {
				elements: b[1],
				classes: c,
				styles: d,
		...
		function I(a) {
			return a.type == CKEDITOR.NODE_ELEMENT && ("br" == a.name || y.$block[a.name])
		}
		function l(a, b, c) {
			var d = a.name;
			...
			else if (y.$block[d] || "tr" == d) if ("br" == b) a.previous && !I(a.previous) && (b = z(), b.insertBefore(a)),
			...
			a.replaceWithChildren();
				...
				b: {
					...
					for (var f = 0,
					t = d.length,
					l; f < t; ++f) if (l = d[f], l.type == CKEDITOR.NODE_ELEMENT && !e[l.name]) {
						e = !1;
						break b
					}
					e = !0
				...
				c.push({
					...
					v, u, t = d.length; 0 < t;) l = d[--t],
					f && (l.type == CKEDITOR.NODE_TEXT || l.type == CKEDITOR.NODE_ELEMENT && y.$inline[l.name]) ? (v || (v = new CKEDITOR.htmlParser.element(b), v.insertAfter(a), c.push({
						check: "parent-down",
						el: v
		...
		CKEDITOR.filter = function(a) {
			...
			if (a instanceof CKEDITOR.editor) {
				a = this.editor = a;
				this.customConfig = !0;
				var b = a.config.allowedContent; ! 0 === b ? this.disabled = !0 : (b || (this.customConfig = !1), this.allow(b, "config", 1), this.allow(a.config.extraAllowedContent, "extra", 1), this.allow(L[a.enterMode] + " " + L[a.shiftEnterMode], "default", 1), this.disallow(a.config.disallowedContent))
		...
		CKEDITOR.filter.prototype = {
			...
			applyTo: function(a, b, c, d) {
				...
				a.forEach(function(a) {
					if (a.type == CKEDITOR.NODE_ELEMENT) {
						...
						if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (v = A(e, a, f, g), v & 1) u = !0;
				...
				case "it":
					...
					break;
				case "el-up":
					c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || r[c.name] || l(c, d, a);
					break;
				case "parent-down":
			...
			addTransformations: function(a) {
				...
				if (!this.disabled && a) {
					...
					for (e = 0; e < a.length; ++e) {
						...
						p = void 0;
						c = [];
						for (l = 0; l < b.length; ++l) t = b[l],
						"string" == typeof t ? (t = t.split(/\s*:\s*/), v = t[0], g = null, p = t[1]) : (v = t.check, g = t.left, p = t.right),
						f || (f = t, f = f.element ? f.element: v ? v.match(/^([a-z0-9]+)/i)[0] : f.left.getDefinition().element),
			...
			check: function(a, b, c) {
				...
				e = d.styles,
				t = d.attributes || {},
				e && !CKEDITOR.tools.isEmpty(e) ? (e = v(e), t.style = CKEDITOR.tools.writeCssText(e, !0)) : e = {},
				e = {
					name: d.element,
					attributes: t,
		...
		N = CKEDITOR.filter.transformationsTools = {
			...
			transform: function(a, b) {
				if ("string" == typeof b) a.name = b;
					...
					v;
					a.name = c.element;
					for (f in e) if ("class" == f) for (c = a.classes.join("|"), l = e[f].split(/\s+/); v = l.pop();) - 1 == c.indexOf(v) && a.classes.push(v);
		...
		return {
			load: function(b, c, e, g) {
				...
				if (0 === k) f(!0);
					...
					var D = function(a, b) { (b ? n: q).push(a);
	...
	CKEDITOR.resourceManager.prototype = {
		...
		load: function(a, d, b) {
			...
			n = 0; n < a.length; n++) {
				var q = a[n];
				if (q) if (c[q] || e[q]) k[q] = this.get(q);
				else {
	...
	CKEDITOR.event.implementOn(CKEDITOR.ui); (function() {
		...
		function h(a) {
			...
			c = x[b] || (x[b] = {});
			c.fn ? (c.fn.call(a, a.config), CKEDITOR.getUrl(a.config.customConfig) != b && h(a) || a.fireOnce("customConfigLoaded")) : CKEDITOR.scriptLoader.queue(b,
			function() {
		...
		function D(a) {
			...
			function(c) {
				...
				function() {
					for (var c = ["beforeInit", "init", "afterInit"], f = 0; f < c.length; f++) for (var l = 0; l < d.length; l++) {
						var v = d[l];
		...
		function A(a, b) {
			...
			for (var e = new CKEDITOR.dom.documentFragment,
			f, g, k, h = 0; h < a.length; h++) {
				var u = a[h],
				y = u.startContainer.getAscendant("tr", !0);
				c(u) ? (f || (f = y.getAscendant("table").clone(), f.append(y.getAscendant({
					thead: 1,
					tbody: 1,
					tfoot: 1
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			...
			destroy: function(a) {
				this.fire("beforeDestroy"); ! a && w.call(this);
				this.editable(null);
	...
	CKEDITOR.htmlParser.fragment = function() {
		...
		CKEDITOR.htmlParser.fragment.fromHtml = function(g, h, k) {
			...
			G.onTagOpen = function(e, f, g, k) {
				...
				if (a(f)) m.push(f);
					...
					if ("br" == e) K.push(f);
						...
						for (; ! (k = (g = z.name) ? CKEDITOR.dtd[g] || (z._.isBlockLike ? CKEDITOR.dtd.div: CKEDITOR.dtd.span) : c, f.isUnknown || z.isUnknown || k[e]);) if (z.isOptionalClose) G.onTagClose(g);
						else if (e in b && g in b) g = z.children,
						(g = g[g.length - 1]) && "li" == g.name || D(g = new CKEDITOR.htmlParser.element("li"), z),
						!f.returnPoint && (f.returnPoint = z),
						z = g;
						else if (e in CKEDITOR.dtd.$listItem && !A(e, g)) G.onTagOpen("li" == e ? "ul": "dl", {},
						0, 1);
						else if (g in d && !A(e, g)) ! f.returnPoint && (f.returnPoint = z),
						z = z.parent;
			...
			G.onTagClose = function(a) {
				...
				for (var c = [], d = [], e = z; e != x && e.name != a;) e._.isBlockLike || d.unshift(e),
				c.push(e),
	...
	"use strict"; (function() {
		...
		a.prototype = {
			...
			exec: function(a, c) {
				...
				f,
				D;
				for (D = 0; D < k; D++) if (d && (n = c.type, q = c.name), f = h[D], !(a.nonEditable && !f.options.applyToAll || a.nestedEditable && f.options.excludeNestedEditable)) {
		...
		function a(a, d) {
			...
			function v(a, d) {
				return function(e) {
					if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						...
						v,
						p;
						if (l) for (u(l, 1) && t.push(l); l;) g(l) && (v = c(l)) && u(v) && ((p = c(v)) && !g(p) ? t.push(v) : (f(y).insertAfter(v), v.remove())),
						l = l.previous;
						for (l = 0; l < t.length; l++) t[l].remove();
						if (t = !a || !1 !== ("function" == typeof d ? d(e) : d)) y || CKEDITOR.env.needsBrFiller || e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? y || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem) ? (t = b(e), t = !t || "form" == e.name && "input" == t.name) : t = !1 : t = !1;
						t && e.add(f(a))
					}
				}
			}
			function u(a, b) {
				...
				var c;
				return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(m)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a), a.value = c[0]), !CKEDITOR.env.needsBrFiller && y && (!b || a.parent.name in B) || !y && ((c = a.previous) && "br" == c.name || !c || g(c))) ? !0 : !1
			}
			var p = {
				elements: {}
			},
				...
				return function(b) {
					if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						...
						if ("data-cke-bogus" in d || "data-cke-eol" in d) delete d["data-cke-bogus"];
							...
							var t = c(b); ! d && g(b.parent) ? h(b.parent, f(a)) : g(d) && t && !g(t) && f(a).insertBefore(d)
						}
					}
				}
			} (y);
		...
		function x(a, b) {
			...
			for (var l = 0; l < d.length; l++) a = a.replace(d[l],
			function(a) {
				a = a.replace(f,
				function(a, b, d) {
					return c[d]
			...
			a = a.replace(f,
			function(a, b, d) {
				return "\x3c!--" + K + (b ? "{C}": "") + encodeURIComponent(c[d]).replace(/--/g, "%2D%2D") + "--\x3e"
			});
	...
	CKEDITOR.htmlParser.cssStyle = function(a) {
		...
		CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
			...
			filter: function(a, b) {
				...
				for (;;) {
					h = d.name;
					if (! (k = a.onElementName(b, h))) return this.remove(),
					!1;
					d.name = k;
				...
				var n, q;
				for (n in h) {
					for (k = h[n];;) if (q = a.onAttributeName(b, n)) if (q != n) delete h[n],
					n = q;
					else break;
					else {
						delete h[n];
					...
					q && (!1 === (k = a.onAttribute(b, d, q, k)) ? delete h[q] : h[q] = k)
				}
	...
	CKEDITOR.config.startupMode = "wysiwyg"; (function() {
		function a(a) {
			...
			u = g.getRanges()[0],
			y;
			if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller) if (g = d(g, e)) g.appendBogus(),
			y = CKEDITOR.env.ie;
			...
			!f.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) && (b = u.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div": "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), y = 1, a.cancel());
			y && u.select()
		}
		function d(a, b) {
		...
		CKEDITOR.editable = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				insertElementIntoRange: function(a, b) {
					...
					var g, v;
					if (f) for (; (g = b.getCommonAncestor(0, 1)) && (v = CKEDITOR.dtd[g.getName()]) && (!v || !v[e]);) g.getName() in CKEDITOR.dtd.span ? b.splitElement(g) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(g), b.collapse(!0), g.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div": "p", c.editable());
					b.insertNode(a);
					return ! 0
				},
				...
				setup: function() {
					...
					function() {
						var b = this.getData();
						this.is("textarea") || !1 !== a.config.ignoreEmptyParagraph && (b = b.replace(G,
						function(a, b) {
							return b
						}));
						a.setData(b, null, 1)
					...
					if (!this.is("textarea")) {
						...
						if (h) {
							...
							u ? h != u.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? u.$.styleSheet.cssText = h: u.setText(h)) : (h = e.appendStyleText(h), h = new CKEDITOR.dom.element(h.ownerNode || h.owningElement), k.setCustomData("stylesheet", h), h.data("cke-temp", 1))
						}
						...
						function(b) {
							...
							if (c in y && (b = a.getSelection(), 0 !== b.getRanges().length)) {
								...
								if (d.collapsed) a: {
									...
									if (e && d[c ? "checkStartOfBlock": "checkEndOfBlock"]() && d.moveToClosestEditablePosition(e, !c) && d.collapsed) {
										...
										if (!d || d && d.contains(e)) b = void 0;
											...
											a.fire("saveSnapshot");
											var p; (p = (c ? d: e).getBogus()) && p.remove();
											p = a.getSelection();
											f = p.createBookmarks(); (c ? e: d).moveChildren(c ? d: e, !1);
								...
								p = b.block,
								d = c.endPath().block,
								p && d && !p.equals(d) ? (a.fire("saveSnapshot"), (e = p.getBogus()) && e.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(p, !1), b.lastElement.mergeSiblings(), q(p, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
								if (!b) return;
		...
		x = function() {
			...
			function b(c, d) {
				...
				e = d.range.startPath();
				for (var k = v[k.getName()], h = 0, B = c.getChildren(), n = B.count(), L = -1, q = -1, E = 0, H = e.contains(v.$list); h < n; ++h) e = B.getItem(h),
				a(e) ? (u = e.getName(), H && u in CKEDITOR.dtd.$list ? y = y.concat(b(e, d)) : (g = !!k[u], "br" != u || !e.data("cke-eol") || h && h != n - 1 || (E = (f = h ? y[h - 1].node: B.getItem(h + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && v.$block[f.getName()]), -1 != L || g || (L = h), g || (q = h), y.push({
					isElement: 1,
					isLineBreak: E,
			...
			function d(b, c) {
				...
				for (h && e.push(" "); y < u; y++) g = f.getItem(y),
			...
			function u(b, c, d, e) {
				...
				g,
				v;
				f.setEndAt(c, CKEDITOR.POSITION_BEFORE_END); (g = (new CKEDITOR.dom.walker(f)).next()) && a(g) && B[g.getName()] && (v = g.getPrevious()) && a(v) && !v.getParent().equals(b.startContainer) && d.contains(v) && e.contains(g) && g.isIdentical(v) && (g.moveChildren(v), g.remove(), u(b, c, d, e))
			}
			function g(b, c) {
				function d(b, c) {
			...
			return function(B, p, C, t) {
				...
				if (!t.checkReadOnly()) {
					...
					t = B.mergeCandidates;
					var m, w;
					"text" == B.type && p.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (m = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", p.document), p.insertNode(m), p.setStartAfter(m));
					...
					m = p.createBookmark(); (F = m.startNode.getPrevious(c)) && a(F) && f(F) && t.push(F); (F = m.startNode.getNext(c)) && a(F) && f(F) && t.push(F);
					...
					if (m = C) {
						...
						if ("text" == B.type && B.inlineStylesRoot) {
							...
							for (t = B.inlineStylesRoot.getParent(); ! w.equals(t);) p = p.appendTo(w.clone()),
							w = w.getParent();
						...
						if ((D = m.startPath().block) && (1 != D.getChildCount() || !D.getBogus())) a: {
							var A;
							if (1 == w.getChildCount() && a(A = w.getFirst()) && A.is(L) && !A.hasAttribute("contenteditable")) {
					...
					if (m) {
						...
						for (g(p, A); t < p.length; t++) {
							...
							if (M) C = 0 < t;
								...
								M = A.startPath(); ! q.isBlock && h(B.editor, M.block, M.blockLimit) && (S = k(B.editor)) && (S = m.createElement(S), S.appendBogus(), A.insertNode(S), CKEDITOR.env.needsBrFiller && (z = S.getBogus()) && z.remove(), A.moveToPosition(S, CKEDITOR.POSITION_BEFORE_END));
								if ((M = A.startPath().block) && !M.equals(G)) {
									if (z = M.getBogus()) z.remove(),
									D.push(M);
									G = M
								}
								...
								if (F && q.isElement) {
									...
									if (M) I && (K = A.splitElement(I), B.zombies.push(K), B.zombies.push(I));
										...
										M = t == p.length - 1;
										I = d(q.node, I);
										for (var R = [], Z = I.length, aa = 0, ca = void 0, da = 0, T = -1; aa < Z; aa++) ca = I[aa],
										" " == ca ? (da || W && !aa || (R.push(new CKEDITOR.dom.text(" ")), T = R.length), da = 1) : (R.push(ca), da = 0);
										M && T == R.length && R.pop();
										W = R
									}
								}
				...
				table: function() {
					function a(c) {
						...
						g.guard = function(a, g) {
							...
							if (g && k && a.equals(k)) f = c.clone(),
							f.setEndAt(k, CKEDITOR.POSITION_BEFORE_END),
							e.push(f);
							else if (!g && h && a.equals(h)) f = c.clone(),
							f.setStartAt(h, CKEDITOR.POSITION_AFTER_START),
							e.push(f);
							else {
								if (F = !g) F = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!k || b(a, k)) && (!h || b(a, h));
					...
					return {
						...
						detectRanges: function(e, f) {
							...
							p = p.contains("table");
							l = l.contains("table");
							if (p || l) p && l && b(p, l) ? (e.tableSurroundingRange = k, k.setStartAt(p, CKEDITOR.POSITION_AFTER_END), k.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), k = g.clone(), k.setEndAt(p, CKEDITOR.POSITION_AFTER_END), h = g.clone(), h.setStartAt(l, CKEDITOR.POSITION_BEFORE_START), h = a(k).concat(a(h))) : p ? l || (e.tableSurroundingRange = k, k.setStartAt(p, CKEDITOR.POSITION_AFTER_END), g.setEndAt(p, CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange = k, k.setEndAt(l, CKEDITOR.POSITION_BEFORE_START), g.setStartAt(l, CKEDITOR.POSITION_AFTER_START)),
		...
		function d(a) {
			...
			d,
			e;
			for (e = 0; e < a.length; e++) d = a[e]._getTableElement(),
			d.is && d.is({
				td: 1,
				th: 1
				...
				if (!c.collapsed) {
					...
					d.evaluator = function(d) {
						if (d.type == CKEDITOR.NODE_ELEMENT && d.isReadOnly()) {
							...
							d.getPosition(p.endContainer) & CKEDITOR.POSITION_CONTAINS || (e.setStartAfter(d), e.collapsed || a.splice(b + 1, 0, e));
							return ! 0
						}
						return ! 1
					};
		...
		function(a) {
			...
			function() {
				...
				function() {
					y && CKEDITOR.env.webkit && (y = c._.previousActive && c._.previousActive.equals(k.getActive())) && null != c._.previousScrollTop && c._.previousScrollTop != h.$.scrollTop && (h.$.scrollTop = c._.previousScrollTop);
					c.unlockSelection(y);
					y = 0
				},
				null, null, -1);
				...
				if (CKEDITOR.env.ie || l) x ? h.attachListener(h, "beforedeactivate", a, null, null, -1) : h.attachListener(c, "selectionCheck", a, null, null, -1),
				...
				if (CKEDITOR.env.ie && !l) {
					...
					h.attachListener(h, "mousedown",
					function(a) {
						2 == a.data.$.button && ((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (n = c.window.getScrollPosition()))
					});
					...
					if ("BackCompat" != k.$.compatMode) {
							...
							function(a) {
								function b(a) {
									...
									if (m) {
										...
										m.setEndPoint(0 > w.compareEndPoints("StartToStart", c) ? "EndToEnd": "StartToStart", c);
										m.select()
									}
								}
								function c() {
						...
						if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version) u.on("mousedown",
						function(a) {
							a.data.getTarget().is("html") && (p.on("mouseup", b), u.on("mouseup", b))
						})
					}
				}
				h.attachListener(h, "selectionchange", e, c);
				h.attachListener(h, "keyup", g, c);
				h.attachListener(h, "keydown",
				function(a) {
				...
				if (l && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
					...
					h.attachListener(k.getDocumentElement(), "mouseup",
					function() {
						r && g.call(c);
						r = 0
					})
				} else h.attachListener(CKEDITOR.env.ie ? h: k.getDocumentElement(), "mouseup", g, c);
				CKEDITOR.env.webkit && h.attachListener(k, "keydown",
				function(a) {
		...
		CKEDITOR.editor.prototype.selectionChange = function(a) { (a ? e: g).call(this)
		};
		...
		CKEDITOR.dom.selection.prototype = {
			...
			getRanges: function() {
				...
				function() {
					...
					var b = function(b, c) {
						...
						f, g, h = b.duplicate(), k = 0, l = e.length - 1, u = -1, q, n; k <= l;) if (u = Math.floor((k + l) / 2), f = e[u], h.moveToElementText(f), q = h.compareEndPoints("StartToStart", b), 0 < q) l = u - 1;
						else if (0 > q) k = u + 1;
						else return {
							container: d,
							offset: a(f)
						...
						if ( - 1 == u || u == e.length - 1 && 0 > q) {
							...
							g.nodeType == CKEDITOR.NODE_TEXT && (n = g, h -= g.nodeValue.length);
							return {
								container: n,
								offset: -h
							}
						...
						for (; 0 < h;) try {
							...
							g.nodeType == CKEDITOR.NODE_TEXT && (h -= g.nodeValue.length, n = g),
							f = g
						} catch(m) {
							return {
								container: d,
			...
			selectRanges: function(b) {
				...
				this.reset();
				if (e) for (var e = this.root,
				g, h = 0; h < b.length; ++h) g = b[h],
				g.endContainer.equals(e) && (g.endOffset = Math.min(g.endOffset, e.getChildCount()));
				if (b.length) if (this.isLocked) {
					...
					if (l) this.fake(l);
						...
						if (x) {
							...
							if (d.startContainer.type == CKEDITOR.NODE_ELEMENT && d.startContainer.getName() in C || d.endContainer.type == CKEDITOR.NODE_ELEMENT && d.endContainer.getName() in C) d.shrink(CKEDITOR.NODE_ELEMENT, !0),
							b = d.collapsed;
							m = d.createBookmark();
							C = m.startNode;
							b || (k = m.endNode);
							...
							for (m = 0; m < b.length; m++) {
								if (m < b.length - 1 && (t = b[m], F = b[m + 1], l = t.clone(), l.setStart(t.endContainer, t.endOffset), l.setEnd(F.startContainer, F.startOffset), !l.collapsed && (l.shrink(CKEDITOR.NODE_ELEMENT, !0), d = l.getCommonAncestor(), l = l.getEnclosedNode(), d.isReadOnly() || l && l.isReadOnly()))) {
								...
								d.collapsed && CKEDITOR.env.webkit && n(d) && (l = q(this.root), d.insertNode(l), (t = l.getNext()) && !l.getPrevious() && t.type == CKEDITOR.NODE_ELEMENT && "br" == t.getName() ? (f(this.root), d.moveToPosition(t, CKEDITOR.POSITION_BEFORE_START)) : d.moveToPosition(l, CKEDITOR.POSITION_AFTER_END));
								F.setStart(d.startContainer.$, d.startOffset);
								try {
									F.setEnd(d.endContainer.$, d.endOffset)
								} catch(r) {
									if (0 <= r.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) d.collapse(1),
									F.setEnd(d.endContainer.$, d.endOffset);
									else throw r;
								}
								k.addRange(F)
	...
	CKEDITOR.STYLE_OBJECT = 3; (function() {
			...
			c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END);
				...
				for (r.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
					...
					l = !0;
						...
						if (x && m && CKEDITOR.dtd.$block[A]) for (var z = r,
						y = e(z), E = void 0, H = y.length, I = 0, z = H && new CKEDITOR.dom.range(z.getDocument()); I < H; ++I) {
							var E = y[I],
							J = CKEDITOR.filter.instances[E.data("cke-filter")];
							if (J ? J.check(this) : 1) z.selectNodeContents(E),
							b.call(this, z)
						}
						y = A ? !q[A] || D ? 0 : x && !m ? 0 : d(r, u, h, V) : 1;
						if (y) if (E = r.getParent(), y = h, H = g, I = k, !E || !(E.getDtd() || CKEDITOR.dtd.span)[H] && !I || y.parentRule && !y.parentRule(E)) l = !0;
						else {
							if (v || A && CKEDITOR.dtd.$removeEmpty[A] && (r.getPosition(u) | V) != V || (v = c.clone(), v.setStartBefore(r)), A = r.type, A == CKEDITOR.NODE_TEXT || x || A == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) {
								for (var A = r,
								L; (l = !A.getNext(B)) && (L = A.getParent(), q[L.getName()]) && d(L, w, h, O);) A = L;
								v.setEndAfter(A)
							}
						} else l = !0;
					...
					if (l && v && !v.collapsed) {
						for (var l = K(this, f), x = l.hasAttributes(), D = v.getCommonAncestor(), A = {},
						y = {},
						E = {},
						H = {},
						T, Q, ba; l && D;) {
							if (D.getName() == g) {
								for (T in h.attributes) ! H[T] && (ba = D.getAttribute(Q)) && (l.getAttribute(T) == ba ? y[T] = 1 : H[T] = 1);
		...
		function c(a) {
			...
			if (a.collapsed) {
				...
				n = this;
				b();
				for (f = d; ! f.equals(q);) g = f.getNextSourceNode(),
				f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? A.call(this, f) : x(f, l(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())),
				f = g
			}
			a.moveToBookmark(c);
		...
		function k(a) {
			...
			f; d = c.getNextParagraph();) ! d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = K(this, e, d), q(d, f));
			a.moveToBookmark(b)
		}
		function n(a) {
			...
			for (var d, e; d = c.getNextParagraph();) this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null: a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p": "div")) && d.copyAttributes(e), q(d, e)) : A.call(this, d));
			a.moveToBookmark(b)
		}
		function q(a, b) {
			var c = !b;
		...
		function G(a) {
			for (var b = l(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e),
			d.isReadOnly() || A.call(this, d, !0);
			for (var f in b) if (f != this.element) for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--) d = c.getItem(e),
			d.isReadOnly() || x(d, b[f])
		}
		function x(a, b, c) {
		...
		function I(a, b) {
			for (var c in a) a[c] = a[c].replace(v,
			function(a, c) {
				return b[c]
			})
		}
		...
		CKEDITOR.style.prototype = {
			...
			removeFromRange: function(a) {
				this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? c: this.type == CKEDITOR.STYLE_BLOCK ? n: this.type == CKEDITOR.STYLE_OBJECT ? h: null;
	...
	"use strict"; (function() {
		...
		CKEDITOR.dom.elementPath = function(b, e) {
			...
			if (n.type == CKEDITOR.NODE_ELEMENT) {
				...
				if (n.equals(e)) break;
				if (!h && (q = n.getName(), "true" == n.getAttribute("contenteditable") ? h = n: !g && d[q] && (g = n), a[q])) {
					if (q = !g && "div" == q) {
						a: {
							q = n.getChildren();
							for (var f = 0,
		...
		var d = {
				...
				return {
					getNextRange: function(h) {
						...
						if (k && 1 < a.length) {
							...
							for (k.moveToBookmark(d.shift()); q--;) n = a[++g],
			...
			createBookmarks: function(b) {
				for (var c = [], d, g = 0; g < this.length; g++) {
					...
					for (var h = g + 1; h < this.length; h++) this[h] = a(d, this[h]),
					this[h] = a(d, this[h], !0)
				}
				return c
			},
...
*/
	...
	CKEDITOR.DIALOG_STATE_BUSY = 2; (function() {
		...
		CKEDITOR.dialog = function(a, b) {
			...
			function d(b) {
				if (l == CKEDITOR.dialog._.currentTop) {
					...
					g = [37, 38, 39, 40];
					q = n = 0;
					if (9 == c || c == CKEDITOR.SHIFT + 9) e(c == CKEDITOR.SHIFT + 9 ? -1 : 1),
					q = 1;
					else if (c == CKEDITOR.ALT + 121 && !l._.tabBarMode && 1 < l.getPageCount()) l._.tabBarMode = !0,
					l._.tabs[l._.currentTabId][0].focus(),
					l._.currentFocusIndex = -1,
					q = 1;
					else if ( - 1 != CKEDITOR.tools.indexOf(g, c) && l._.tabBarMode) c = -1 != CKEDITOR.tools.indexOf([d ? 39 : 37, 38], c) ? x.call(l) : A.call(l),
					l.selectPage(c),
					l._.tabs[c][0].focus(),
					q = 1;
		...
		CKEDITOR.dialog.prototype = {
			...
			addPage: function(a) {
				if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
					...
					f = e.getChild(), g = 0; e = f.shift();) e.notAllowed || "hbox" == e.type || "vbox" == e.type || g++,
					d[e.id] = e,
		...
		D = function(a, b, c) {
			for (var e = 0,
			d; d = a[e]; e++) if (d.id == b || c && d[c] && (d = D(d[c], b, c))) return d;
			return null
		},
		...
		S = function(a, b, c, e, d) { (w[c] || (w[c] = [])).push({
				uiElement: a,
				dialog: b,
				key: c,
	...
	CKEDITOR.config.coreStyles_superscript = {
		...
		function q(a, f, d, b) {
			if (!a.isReadOnly() && !a.equals(d.editable())) {
				...
				b = "useComputedState" in d.config ? d.config.useComputedState: 1; (b ? a.getComputedStyle("direction") : a.getStyle("direction") || a.hasAttribute("dir")) != f && (a.removeStyle("direction"), b ? (a.removeAttribute("dir"), f != a.getComputedStyle("direction") && a.setAttribute("dir", f)) : a.setAttribute("dir", f), d.forceNextSelectionCheck())
			}
		}
		function v(a, f, d) {
		...
		function p(a) {
			return {
				...
				exec: function(f) {
					...
					if (c && c.length) {
						for (var h = {},
						e = d.createBookmarks(), c = c.createIterator(), g, l = 0; g = c.getNextRange(1);) {
		...
		for (var l = CKEDITOR.dom.element.prototype,
		n = ["setStyle", "removeStyle", "setAttribute", "removeAttribute"], m = 0; m < n.length; m++) l[n[m]] = CKEDITOR.tools.override(l[n[m]], w)
	})(); (function() {
		var m = {
			exec: function(g) {
	...
	Notification.prototype = {
		...
		update: function(b) {
			var a = !0; ! 1 === this.editor.fire("notificationUpdate", {
				notification: this,
				options: b
			}) && (a = !1);
			var c = this.element,
		...
		hide: function() { ! 1 !== this.editor.fire("notificationHide", {
				notification: this
	...
	Area.prototype = {
		...
		_layout: function() {
			...
			d.width < g + h ? e.x + g + h > p.x + q.width ? b() : a.setStyle("left", k(n)) : e.x + g + h > p.x + q.width ? a.setStyle("left", k(n)) : e.x + d.width / 2 + g / 2 + h > p.x + q.width ? a.setStyle("left", k(n - e.x + p.x + q.width - g - h)) : 0 > d.left + d.width - g - h ? b() : 0 > d.left + d.width / 2 - g / 2 ? a.setStyle("left", k(n - e.x + p.x)) : a.setStyle("left", k(n + d.width / 2 - g / 2 - h / 2))
		}
	};
	CKEDITOR.plugins.notification = Notification; (function() {
		...
		CKEDITOR.ui.button.prototype = {
			render: function(a, b) {
				...
				v = CKEDITOR.tools.addFunction(function(a) {
					if (e.onkey) return a = new CKEDITOR.dom.event(a),
				...
				} else d && (d = a.getCommand(d)) && (d.on("state",
				function() {
		...
		function D(a) {
			function d() {
				for (var b = f(), e = CKEDITOR.tools.clone(a.config.toolbarGroups) || v(a), n = 0; n < e.length; n++) {
					...
					if ("/" != g) {
						...
						var l, d = g.groups;
						if (d) for (var h = 0; h < d.length; h++) l = d[h],
						(l = b[l]) && c(g, l); (l = b[g.name]) && c(g, l)
					}
				}
				return e
			}
			function f() {
				var b = {},
				c, e, g;
				for (c in a.ui.items) e = a.ui.items[c],
				g = e.toolbar || "others",
				g = g.split(","),
				e = g[0],
				g = parseInt(g[1] || -1, 10),
			...
			function c(c, e) {
				if (e.length) {
					...
					for (var d; d = e.shift();) d = "string" == typeof d ? d: d.name,
		...
		z.prototype.focus = function() {
			for (var a = 0,
			d; d = this.toolbars[a++];) for (var f = 0,
			c; c = d.items[f++];) if (c.focus) {
				c.focus();
				return
			}
		};
			...
			init: function(a) {
				var d, f = function(c, h) {
					...
					case q:
						...
						return ! 1;
					case 40:
						return c.button && c.button.hasArrow ? c.execute() : f(c, 40 == h ? q: e),
						!1;
					case e:
					case 38:
						b = c;
				...
				function(c) {
					if (c.data.space == a.config.toolbarLocation) {
						...
						for (var q = a.toolbox.toolbars,
						n = D(a), g = n.length, l = 0; l < g; l++) {
							var r, m = 0,
							w, p = n[l],
							v = "/" !== p && ("/" === n[l + 1] || l == g - 1),
							x;
				...
				function() {
					if (this.toolbox) {
						var a, d = 0,
						b, e, f;
						for (a = this.toolbox.toolbars; d < a.length; d++) for (e = a[d].items, b = 0; b < e.length; b++) f = e[b],
	...
	CKEDITOR.config.toolbarLocation = "top"; (function() {
		...
		function y(b) {
			function a() {
				...
				a.on(m.mainPasteEvent,
				function(b) {
					"beforepaste" == m.mainPasteEvent && n || t(b)
				});
				"beforepaste" == m.mainPasteEvent && (a.on("paste",
				function(b) {
			...
			function d() {
				return {
					...
					exec: function(b, a) {
						...
						l = "string" === typeof d ? d: b.lang.clipboard.pasteNotification.replace(/%1/, '\x3ckbd aria-label\x3d"' + h.aria + '"\x3e' + h.display + "\x3c/kbd\x3e"),
			...
			function k(a, c) {
				...
				if (!d.getById("cke_pastebin")) {
					...
					CKEDITOR.env.safari && f.setStyles(CKEDITOR.tools.cssVendorPrefix("user-select", "text")); (k = f.getParent().isReadOnly()) ? (f.setOpacity(0), f.setAttribute("contenteditable", !0)) : f.setStyle("ltr" == b.config.contentsLangDirection ? "left": "right", "-10000px");
					b.on("selectionChange", g, null, null, 0);
					if (CKEDITOR.env.webkit || CKEDITOR.env.gecko) h = e.once("blur", g, null, null, -100);
					k && f.focus();
			...
			function v() {
				...
				a.lock();
				if (b.editable().fire(m.mainPasteEvent) && !e("paste")) return a.unlock(),
				!1;
				a.unlock();
				return ! 0
			}
		...
		function E(b) {
			...
			function() {
				...
				function() {
					...
					CKEDITOR.env.ie && 10 > CKEDITOR.env.version && (a.dragStartContainerChildCount = c ? g(c.startContainer) : null, a.dragEndContainerChildCount = c ? g(c.endContainer) : null)
				},
				null, null, 100);
			...
			init: function(b) {
				...
				function(a) {
					...
					if (!a.data.dataValue) {
						...
						if (d) a.data.dataValue = d,
						a.data.type = "html";
						else if (d = c.getData("text/plain")) a.data.dataValue = b.editable().transformPlainTextToHtml(d),
						a.data.type = "text"
					}
				},
				null, null, 1);
				...
				function(b) {
					...
					c = CKEDITOR.dtd.$block; - 1 < a.indexOf("Apple-") && (a = a.replace(/<span class="Apple-converted-space">&nbsp;<\/span>/gi, " "), "html" != b.data.type && (a = a.replace(/<span class="Apple-tab-span"[^>]*>([^<]*)<\/span>/gi,
					function(a, b) {
					...
					if (a.match(/^<[^<]+cke_(editable|contents)/i)) {
						...
						for (l.setHtml(a); 1 == l.getChildCount() && (d = l.getFirst()) && d.type == CKEDITOR.NODE_ELEMENT && (d.hasClass("cke_editable") || d.hasClass("cke_contents"));) l = f = d;
						f && (a = f.getHtml().replace(/<br>$/i, ""))
					}
					CKEDITOR.env.ie ? a = a.replace(/^&nbsp;(?: |\r\n)?<(\w+)/g,
					function(a, e) {
						return e.toLowerCase() in c ? (b.data.preSniffing = "html", "\x3c" + e) : a
					}) : CKEDITOR.env.webkit ? a = a.replace(/<\/(\w+)><div><br><\/div>$/,
					function(a, e) {
		...
		CKEDITOR.plugins.clipboard = {
			...
			fixSplitNodesAfterDrop: function(b, a, c, d) {
				function f(b, c, d) {
					...
					if (f.equals(c) && d != c.getChildCount()) return b = a.startContainer.getChild(a.startOffset - 1),
				...
				"number" == typeof d && "number" == typeof c && g.type == CKEDITOR.NODE_ELEMENT && (f(b.startContainer, g, c) || f(b.endContainer, g, d))
			},
			...
			internalDrop: function(b, a, c, d) {
				...
				CKEDITOR.env.ie && 10 > CKEDITOR.env.version && this.fixSplitNodesAfterDrop(b, a, f.dragStartContainerChildCount, f.dragEndContainerChildCount); (h = this.isDropRangeAffectedByDragRange(b, a)) || (e = b.createBookmark(!1));
			...
			getRangeAtDropPosition: function(b, a) {
				...
				if (document.caretRangeFromPoint && a.document.$.caretRangeFromPoint(d, f)) c = a.document.$.caretRangeFromPoint(d, f),
		...
		CKEDITOR.ui.panel.block = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				onKeyDown: function(a, b) {
					...
					switch (e) {
					case "next":
						for (var d = this._.focusIndex,
						e = this.element.getElementsByTag("a"), c; c = e.getItem(++d);) if (c.getAttribute("_cke_focus") && c.$.offsetWidth) {
							this._.focusIndex = d;
							c.focus();
							break
						}
		...
		CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				showBlock: function(a, b, c, m, h, g) {
					...
					q = "rtl" == this._.dir,
					d = t.x + (m || 0) - f.x,
					p = t.y + (h || 0) - f.y; ! q || 1 != c && 4 != c ? q || 2 != c && 3 != c || (d += b.$.offsetWidth - 1) : d += b.$.offsetWidth;
				...
				d.ui.add(a, CKEDITOR.UI_PANELBUTTON, {
					...
					onOpen: function() {
						...
						if (c) {
							...
							do c = b && b.getComputedStyle("back" == e ? "background-color": "color") || "transparent";
							while ("back" == e && "transparent" == c && b && (b = b.getParent()));
	...
	CKEDITOR.plugins.add("menu", {
		...
		beforeInit: function(l) {
			for (var h = l.config.menu_groups.split(","), r = l._.menuGroups = {},
			t = l._.menuItems = {},
			n = 0; n < h.length; n++) r[h[n]] = n + 1;
		...
		CKEDITOR.menu = CKEDITOR.tools.createClass({
			$: function(a, b) {
				...
				m = d.block.attributes = d.attributes || {}; ! m.role && (m.role = "menu");
	...
	CKEDITOR.plugins.add("contextmenu", {
		...
		CKEDITOR.plugins.add("copyformatting", {
			...
			init: function(a) {
				...
				function() {
					...
					d.attachListener(b, "mouseup",
					function(b) {
						r(b) === CKEDITOR.MOUSE_BUTTON_LEFT && a.execCommand("applyFormatting")
					});
					d.attachListener(CKEDITOR.document, "mouseup",
					function(b) {
					...
					c && (b = CKEDITOR.document.getById(c._.id), d.attachListener(b, "dblclick",
					function() {
				...
				a.copyFormatting.on("extractFormatting",
				function(d) {
				...
				function(d) {
					if (!d.data.preventFormatStripping) {
						...
						g,
						h;
						if (a.copyFormatting._isContextAllowed(f)) for (h = 0; h < c.length; h++) f = c[h],
						g = e.createBookmark(),
						-1 === l(b.preservedElements, f.element) ? CKEDITOR.env.webkit && !CKEDITOR.env.chrome ? c[h].removeFromRange(d.data.range, d.editor) : c[h].remove(d.editor) : u(f.element, d.data.styles) && b._removeStylesFromElementInRange(e, f.element),
						e.moveToBookmark(g)
					}
				});
				a.copyFormatting.on("applyFormatting",
		...
		CKEDITOR.plugins.copyformatting = {
			...
			commands: {
				copyFormatting: {
					exec: function(a, b) {
						...
						if (this.state === CKEDITOR.TRISTATE_ON) return e.styles = null,
						e.sticky = !1,
				...
				applyFormatting: {
					...
					exec: function(a, b) {
						...
						if (e || d.state === CKEDITOR.TRISTATE_ON) {
							if (e && !f.styles) return c._putScreenReaderMessage(a, "failed"),
			...
			_getSelectedWordOffset: function(a) {
				...
				for (f = d(h); null != (g = c.exec(f));) if (g.index + g[0].length >= a.startOffset) return a = g.index,
			...
			_filterStyles: function(a) {
				...
				e,
				c;
				for (c = 0; c < a.length; c++) e = a[c]._.definition,
				-1 !== CKEDITOR.tools.indexOf(CKEDITOR.plugins.copyformatting.inlineBoundary, e.element) && (e.element = a[c].element = "span"),
			...
			_applyStylesToTableContext: function(a, b, d) {
				...
				var c, f, g;
				for (g = 0; g < d.length; g++) c = d[g],
				f = b.createBookmark(),
				-1 !== l(["table", "tr"], c.element) ? k(b, c.element,
				function(a) {
					c.applyToObject(a)
	...
	CKEDITOR.plugins.add("resize", {
		...
		function q(a, e) {
			...
			k = a._.elementsPath,
			q = k.idBase;
			e.html += '\x3cspan id\x3d"' + p + '_label" class\x3d"cke_voice_label"\x3e' + a.lang.elementspath.eleLabel + '\x3c/span\x3e\x3cspan id\x3d"' + p + '" class\x3d"cke_path" role\x3d"group" aria-labelledby\x3d"' + p + '_label"\x3e\x3cspan class\x3d"cke_path_empty"\x3e\x26nbsp;\x3c/span\x3e\x3c/span\x3e';
			a.on("uiReady",
			function() {
			...
			function() {
				for (var c = [], d = k.list = [], g = [], b = k.filters, e = !0, l = a.elementPath().elements, f, u = l.length; u--;) {
					var h = l[u],
					r = 0;
					f = h.data("cke-display-name") ? h.data("cke-display-name") : h.data("cke-real-element-type") ? h.data("cke-real-element-type") : h.getName(); (e = h.hasAttribute("contenteditable") ? "true" == h.getAttribute("contenteditable") : e) || h.hasAttribute("contenteditable") || (r = 1);
			...
			proto: {
				...
				render: function(a, b) {
					...
					g = {
						...
						execute: function(b) {
							var c = d._;
							if (c.state != CKEDITOR.TRISTATE_DISABLED) if (d.createPanel(a), c.on) c.panel.hide();
							else {
								d.commit();
								var f = d.getValue();
					...
					a.on("mode", f, this);
					a.on("selectionChange", f, this); ! this.readOnly && a.on("readOnly", f, this);
						...
						if (f.collapsed) {
							...
							if (k) {
								...
								if (d && l) {
									...
									k.remove();
									f.moveToBookmark(d)
								} else d || l ? f.moveToPosition(k, d ? CKEDITOR.POSITION_BEFORE_START: CKEDITOR.POSITION_AFTER_END) : (f.splitElement(k), f.moveToPosition(k, CKEDITOR.POSITION_AFTER_END)),
	...
	CKEDITOR.config.image_removeLinkByEmptyURL = !0; (function() {
		...
		function w(d) {
			function f(b) {
				for (var e = c.startContainer,
				a = c.endContainer; e && !e.getParent().equals(b);) e = e.getParent();
				...
				for (var g = l.isIndent ? 1 : -1, a = e[0], e = e[e.length - 1], k = CKEDITOR.plugins.list.listToArray(b, q), h = k[e.getCustomData("listarray_index")].indent, a = a.getCustomData("listarray_index"); a <= e.getCustomData("listarray_index"); a++) if (k[a].indent += g, 0 < g) {
					var n = k[a].parent;
				...
				if (r && r.length) for (a = 0; a < r.length; a++) {
					for (m = b = r[a]; (m = m.getNext()) && m.is && m.getName() in p;) CKEDITOR.env.needsNbspFiller && !b.getFirst(x) && b.append(c.document.createText(" ")),
					b.append(m);
					b.insertAfter(f)
				}
			...
			q = this.database,
			p = this.context,
			c, n = d.getSelection(), n = (n && n.getRanges()).createIterator(); c = n.getNextRange();) {
				...
				b && c.endContainer.type == CKEDITOR.NODE_ELEMENT && c.endContainer.getName() in p && (h = new CKEDITOR.dom.walker(c), h.evaluator = t, c.endContainer = h.previous());
				if (b) return f(b)
			}
			return 0
		}
				...
				function f(d) {
					...
					function(f) {
						...
						if ("wysiwyg" == d.mode && f.data.keyCode == this.indentKey && c) {
							var n = this.getContext(c); ! n || this.isIndent && CKEDITOR.plugins.indentList.firstItemInPath(this.context, c, n) || (d.execCommand(this.relatedGlobal), f.cancel())
						}
					},
					this);
	...
	CKEDITOR.config.smiley_descriptions = "smiley;sad;wink;laugh;frown;cheeky;blush;surprise;indecision;angry;angel;cool;devil;crying;enlightened;no;yes;heart;broken heart;kiss;mail".split(";"); (function() {
		...
		function m(a) {
			...
			for (var f = new CKEDITOR.dom.walker(b), d; d = f.next();) if (d.type == CKEDITOR.NODE_ELEMENT) if (!d.equals(a.data.node) && d.getDirection()) b.setStartAfter(d),
	...
	CKEDITOR.UI_MENUBUTTON = "menubutton"; (function() {
		...
		function r(c, b) {
			...
			for (var g = 0; g < d.length; g++) a = d[g].toLowerCase(),
			f = b[a],
			0 < g && e.push(","),
		...
		CKEDITOR.plugins.link = {
			getSelectedLink: function(c, b) {
				...
				for (d = 0; d < f.length; d++) if (g = a.getRanges()[d], g.shrink(CKEDITOR.SHRINK_TEXT, !1, {
					skipBogus: !0
			...
			parseLinkAttributes: function(c, b) {
				...
				e,
				g = {};
				a.match(t) && ("encode" == f ? a = a.replace(A,
				function(a, b, c) {
					c = c || "";
				...
				function(a, b, c) {
					if (b == d.name) {
						...
						c = c.match(/[^,\s]+/g);
						for (var e = c.length,
						f, h, k = 0; k < e; k++) f = decodeURIComponent,
				...
				if (!g.type) if (f = a.match(x)) g.type = "anchor",
				g.anchor = {},
				...
				} else a && (e = a.match(y)) && (g.type = "url", g.url = {},
				g.url.protocol = e[1], g.url.url = e[2]);
				if (b) {
			...
			init: function(a) {
				...
				function(d) {
					...
					if (g && (c || h) && (!1 !== a.fire("pasteFromWord", e) || c)) {
						...
						function() {
							if (k) a.fire("paste", b);
							else if (!a.config.pasteFromWordPromptCleanup || c || confirm(a.lang.pastefromword.confirmCleanup)) e.dataValue = CKEDITOR.cleanWord(e.dataValue, a),
	...
	CKEDITOR.config.removeFormatAttributes = "class,style,lang,width,height,align,hspace,valign"; (function() {
		...
		CKEDITOR.plugins.add("showblocks", {
			onLoad: function() {
				...
				b += ".cke_show_blocks " + d + g + "{background-image:url(" + CKEDITOR.getUrl(k + "images/block_" + d + ".png") + ")}";
	...
	CKEDITOR.plugins.scayt = {
		...
		createScayt: function(a) {
			...
			function(a) {
				...
				if (f) {
					...
					g.subscribe("suggestionListSend",
					function(a) {
						for (var b = {},
					...
					g.subscribe("selectionIsChanged",
					function(d) {
						a.getSelection().isLocked && a.lockSelection()
					});
					g.subscribe("graytStateChanged",
					function(c) {
		...
		loadScaytLibrary: function(a, c) {
			...
			"undefined" === typeof window.SCAYT || "function" !== typeof window.SCAYT.CKSCAYT ? (d = a.config.scayt_srcUrl + "?" + this.onLoadTimestamp, CKEDITOR.scriptLoader.load(d,
			function(a) {
				a && b()
		...
		CKEDITOR.plugins.add("stylescombo", {
			...
			init: function(c) {
				...
				function(b) {
					if (b = b.data.styles) {
						for (var a, h, d, e = 0,
						n = b.length; e < n; e++)(a = b[e], c.blockless && a.element in CKEDITOR.dtd.$block || "string" == typeof a.type && !CKEDITOR.style.customHandlers[a.type] || (h = a.name, a = new CKEDITOR.style(a), c.filter.customConfig && !c.filter.check(a))) || (a._name = h, a._.enterMode = l.enterMode, a._.type = d = a.assignedTo || a.type, a._.weight = e + 1E3 * (d == CKEDITOR.STYLE_OBJECT ? 1 : d == CKEDITOR.STYLE_BLOCK ? 2 : 3), f[h] = a, k.push(a), m.push(a));
						k.sort(function(a, b) {
	...
	CKEDITOR.plugins.add("table", {
		...
		function r(d, f) {
			for (var b = D(d) ? d: q(d), c = b[0], e = c.getAscendant("table"), c = c.getDocument(), a = b[0].getParent(), g = a.$.rowIndex, b = b[b.length - 1], k = b.getParent().$.rowIndex + b.$.rowSpan - 1, b = new CKEDITOR.dom.element(e.$.rows[k]), g = f ? g: k, a = f ? a: b, b = CKEDITOR.tools.buildTableMap(e), e = b[g], g = f ? b[g - 1] : b[g + 1], b = b[0].length, c = c.createElement("tr"), k = 0; e[k] && k < b; k++) {
				var h;
		...
		function u(d, f) {
			for (var b = D(d) ? d: q(d), c = b[0].getAscendant("table"), e = w(b, 1), b = w(b), a = f ? e: b, g = CKEDITOR.tools.buildTableMap(c), c = [], e = [], b = [], k = g.length, h = 0; h < k; h++) c.push(g[h][a]),
			e.push(f ? g[h][a - 1] : g[h][a + 1]);
		...
		function y(d) {
			...
			d.reset();
			var m = 0;
			for (d = g.length; m < d; m++) for (var n = 0,
			p = g[m].length; n < p; n++) void 0 === k && g[m][n] == e.$ && (k = n),
			g[m][n] == a.$ && (h = n);
			for (m = k; m <= h; m++) for (n = 0; n < g.length; n++) a = g[n],
			e = new CKEDITOR.dom.element(c.$.rows[n]),
			a = new CKEDITOR.dom.element(a[m]),
			a.$ && (1 == a.$.colSpan ? a.remove() : --a.$.colSpan, n += a.$.rowSpan - 1, e.$.cells.length || l.push(e));
		...
		function z(d) {
			if (d instanceof CKEDITOR.dom.selection) {
				...
				a: {
					...
					e = b.length - 1;
					for (var g = {},
					k, h; k = b[a++];) CKEDITOR.dom.element.setMarker(g, k, "delete_cell", !0);
					...
					CKEDITOR.dom.element.clearAllMarkers(g);
					a = b[0].getParent(); (a = a.getPrevious()) ? e = a.getLast() : (a = b[e].getParent(), e = (a = a.getNext()) ? a.getChild(0) : null)
				}
				d.reset();
		...
		function x(d, f, b) {
			...
			c = b.count();
			for (f = c - 1; 0 <= f; f--) e = b.getItem(f),
			e.$.cells.length || (e.remove(), c++);
			return d
		}
		function C(d, f) {
			var b = q(d);
			...
			if (1 < h) {
				l = Math.ceil(h / 2);
				for (var h = Math.floor(h / 2), c = g + l, e = new CKEDITOR.dom.element(e.$.rows[c]), a = A(a, c), m, c = b.clone(), g = 0; g < a.length; g++) if (m = a[g], m.parentNode == e.$ && g > k) {
			...
			init: function(d) {
				...
				b("cellProperties", new CKEDITOR.dialogCommand("cellProperties", f({
					...
					},
					{
						...
						right: function(a) {
							CKEDITOR.tools.array.forEach(a.children,
							function(b) {
								b.name in {
									td: 1,
									th: 1
	...
	CKEDITOR.tools.buildTableMap = function(q, r, B, v, w) {
		...
		for (r = r || 0; r <= v; r++) {
			u++; ! y[u] && (y[u] = []);
			for (var t = -1,
			z = B; z <= ( - 1 === w ? q[r].cells.length - 1 : w); z++) {
				var p = q[r].cells[z];
				if (!p) break;
				for (t++; y[u][t];) t++;
		...
		function x(a, b) {
			...
			f > p && (c = f, f = p, p = c);
			for (c = h; c <= m; c++) for (h = f; h <= p; h++) d = new CKEDITOR.dom.element(e[c][h]),
		...
		function t(a, b) {
			...
			d,
			e;
			for (e = 0; e < b.length; e++) d = a.createRange(),
		...
		function J(a, b, c) {
			...
			b = b.is("table") ? null: b;
			var e; (e = g.active && !g.first) && !(e = b) && (e = a.getSelection().getRanges(), e = 1 < d.length || e[0] && !e[0].collapsed ? !0 : !1);
			if (e) g.first = b || d[0],
			g.dirty = b ? !1 : 1 !== d.length;
		...
		function M(a, b) {
			...
			h.getById("cke_table_copybin") || (p = h.createElement(f), r = h.createElement(f), r.setAttributes({
				...
				height: "1px",
				overflow: "hidden"
			}), p.setStyle("ltr" == a.config.contentsLangDirection ? "left": "right", "-5000px"), p.setHtml(a.getSelectedHtml(!0)), a.fire("lockSnapshot"), r.append(p), a.editable().append(r), g = a.on("selectionChange", c, null, null, 0), k && (B = l.scrollTop), m.selectNodeContents(p), m.select(), k && (l.scrollTop = B), setTimeout(function() {
				r.remove();
				d.selectBookmarks(e);
				g.removeListener();
				a.fire("unlockSnapshot");
		...
		function z(a, b, c) {
			a.on("beforeCommandExec",
			function(d) { - 1 !== CKEDITOR.tools.array.indexOf(b, d.data.name) && (d.data.selectedCells = u(a.getSelection()))
			});
			a.on("afterCommandExec",
		...
		q.prototype.insertRow = function(a, b, c) {
			...
			h = c ? [] : this.cells.all, m, l = 0; l < a; l++) m = D(c ? this.cells.all: h, b),
			m = CKEDITOR.tools.array.filter(m.find("td, th").toArray(),
			function(a) {
		...
		q.prototype.insertColumn = function(a) {
			...
			d = c.all,
			e = n(c.first), h = n(c.last), c = 0; c < a; c++) d = d.concat(CKEDITOR.tools.array.filter(E(d), b));
		...
		var F = {
			onPaste: function(a) {
				function b(a) {
					return Math.max.apply(null, CKEDITOR.tools.array.map(a,
					function(a) {
						return a.length
					},
					0))
				...
				k,
				f; ! h.length || 1 === h.length && !G(e.getRanges()[0]) && !l || l && !m || (h = h[0].getAscendant("table"), k = new q(u(e, h)), d.once("afterPaste",
				function() {
					var a;
					if (f) {
				...
				0)) : (c(k.cells.first), d.once("afterPaste",
				function() {
					d.fire("lockSnapshot");
			...
			pasteTable: function(a, b, c) {
				...
				for (f = 0; f < c.length; f++) for (l = new CKEDITOR.dom.element(h.$.rows[a.rows.first.$.rowIndex + f]), p = 0; p < c[f].length; p++) if (k = new CKEDITOR.dom.element(c[f][p]), d = b[f] && b[f][p] ? new CKEDITOR.dom.element(b[f][p]) : null, k && !k.getCustomData("processed")) {
					...
					else if (0 === p || c[f][p - 1])(d = 0 !== p ? new CKEDITOR.dom.element(c[f][p - 1]) : null) && l.equals(d.getParent()) ? k.insertAfter(d) : 0 < e ? l.$.cells[e] ? k.insertAfter(new CKEDITOR.dom.element(l.$.cells[e])) : l.append(k) : l.append(k, !0);
			...
			keyboardIntegration: function(a) {
				...
				function(a) {
					function c(b, e) {
						...
						CKEDITOR.tools.array.forEach(h,
						function(a) {
							a.enlarge(CKEDITOR.ENLARGE_ELEMENT)
						});
						...
						if (g && g.is && g.is(m)) {
							...
							}; n && !u(n);) n = n.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q); ! n && r && r.is && !r.is("table") && r.getNext() && (n = r.getNext().findOne("td, th"), t = !0);
							if (n) f["moveToElementEdit" + (t ? "Start": "End")](n);
							else f.setStartBefore(g.getAscendant("table", !0)),
							f.collapse(!0);
							h[0].deleteContents();
							return [f]
						}
						if (g) return f.moveToElementEditablePosition(g),
						[f]
					}
					var h = {
						37 : 1,
					...
					return function(l) {
						...
						n,
						q;
						if (h[k] && (f = a.getSelection()) && f.isInTable() && f.isFake) if (g = f.getRanges(), n = g[0]._getTableElement(), q = g[g.length - 1]._getTableElement(), l.data.preventDefault(), l.cancel(), 8 < k && 46 > k) g[0].moveToElementEditablePosition(m ? n: q, !m),
						f.selectRanges([g[0]]);
						else {
							for (l = 0; l < g.length; l++) b(g[l]); (l = c(n, g)) ? g = l: g[0].moveToElementEditablePosition(n);
							f.selectRanges(g);
							a.fire("saveSnapshot")
						}
					}
				} (a), null, null, -1);
				c.attachListener(c, "keypress",
				function(d) {
					var c = a.getSelection(),
		...
		CKEDITOR.plugins.add("tableselection", {
			...
			init: function(a) {
				CKEDITOR.plugins.tableselection.isSupportedEnvironment && (a.addContentsCss && a.addContentsCss(this.path + "styles/tableselection.css"), a.on("contentDom",
				function() {
					var b = a.editable(),
					...
					CKEDITOR.plugins.clipboard && !CKEDITOR.plugins.clipboard.isCustomCopyCutSupported && (b.attachListener(b, "cut", C), b.attachListener(b, "copy", C))
				}), a.on("paste", F.onPaste, F), z(a, "rowInsertBefore rowInsertAfter columnInsertBefore columnInsertAfter cellInsertBefore cellInsertAfter".split(" "),
				function(a, c) {
					t(a, c.selectedCells)
				}), z(a, ["cellMerge", "cellMergeRight", "cellMergeDown"],
				function(a, c) {
