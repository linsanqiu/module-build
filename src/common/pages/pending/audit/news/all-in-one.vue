			...
			<ul slot="content">
				<li>
					<dl>
						<dt>发布日期：</dt>
						<dd>
							<h-date-picker type="datetimerange" format="yyyy-MM-dd" aria-placeholder="发布日期" :placeholder="placeholders.publishDateRange" :value="commonFilters.publishDateRange" @on-change="onChangeDateRangePicker">
							</h-date-picker>
						</dd>
					</dl>
				</li>
				<li>
					<dl>
						<dt>公开标志：</dt>
						<dd>
							<h-select aria-placeholder="公开标志" placeholder="请选择公开标志" v-model="commonFilters.newsOpenFlag" @on-change="onChangeSelect(`newsOpenFlag`)" :clearable="true">
								<h-option v-for="(item, i) in newsOpenFlags" :value="item.value" :key="i">
									{{item.title}}
								</h-option>
							</h-select>
						</dd>
				...
				<li>
					<dl>
						<dt>处理状态：</dt>
						<dd>
							<h-select aria-placeholder="处理状态" placeholder="请选择处理状态" v-model="commonFilters.processingStatus" @on-change="onChangeSelect(`processingStatus`)" clearable >
								<h-option v-for="(item, i) in processingStates" :value="item.value" :key="i">
									{{item.title}}
								</h-option>
							</h-select>
						</dd>
				...
				<li>
					<dl>
						<dt>优先级：</dt>
						<dd>
							<h-select placeholder="请选择优先级" v-model="commonFilters.priority">
								<h-option v-for="(item, i) in priorities" :value="item.value" :key="i">
									{{item.title}}
								</h-option>
							</h-select>
						</dd>
				...
				<li>
					<dl>
						<dt>资讯ID：</dt>
						<dd>
							<h-input placeholder="请输入资讯ID" v-model="commonFilters.newsId" @on-change="onChangeInput(`newsId`)" @on-enter="onChangeInputEnter(`newsId`)" icon="android-close" ref="newsId" @on-click="shitClearableClick(`newsId`)"></h-input>
						</dd>
					</dl>
				</li>
				<li>
					<dl>
						<dt>资讯类型：</dt>
						<dd>
							<h-select aria-placeholder="资讯类型" placeholder="请选择资讯类型" v-model="newsListType" @on-change="onNewsListTypeSelectChange(`newsListType`)" filterable clearable>
							<h-option v-for="(item, i) in newsListTypes" :value="item.value" :key="i">
								{{item.title}}
							</h-option>
						</h-select>
						</dd>
				...
				<li>
					<dl>
						<dt>资讯标题：</dt>
						<dd>
							<h-input placeholder="请输入资讯标题" v-model="commonFilters.newsTitle" @on-change="onChangeInput(`newsTitle`)" @on-enter="onChangeInputEnter(`newsTitle`)" icon="android-close" ref="newsTitle" @on-click="shitClearableClick(`newsTitle`)"></h-input>
						</dd>
					</dl>
				</li>
				<li>
					<dl>
						<dt>标签名：</dt>
						<dd>
							<h-input type="text" placeholder="请输入标签名" v-model="commonFilters.newsTagName" @on-change="onChangeInput(`newsTagName`)" @on-enter="onChangeInputEnter(`newsTagName`)" icon="android-close" ref="newsTagName" @on-click="shitClearableClick(`newsTagName`)"></h-input>
						</dd>
					</dl>
				</li>
				<li>
				...
				<li class="search-wrapper-but">
					...
					<h-tooltip placement="top-end" content="请选择是否自动刷新表格的数据!">
						<h-switch size="large" v-model="isAutoRefreshTable" @on-change="onChangeSwitch">
							<div slot="open">
								<span>打开</span>
							</div>
							<div slot="close">
